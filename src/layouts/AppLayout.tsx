  ...
  if (item.disabled) {
    return (
      ...
      >
        ...
        <span className="text-label-caps group-focus-within:opacity-100 whitespace-nowrap opacity-0 transition-opacity duration-300 group-hover:opacity-100">
          {item.label}
        </span>
      </span>
    )
    ...
    <div className="text-on-background min-h-screen">
      <aside className="group py-safe-margin-y focus-within:w-[320px] fixed top-0 left-0 z-50 flex h-full w-[96px] flex-col overflow-hidden bg-surface-container/80 px-4 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:w-[320px]">
        <div className="mb-8 flex items-center gap-4 px-2 whitespace-nowrap">
          ...
          />
          <span className="text-label-caps group-focus-within:opacity-100 text-primary opacity-0 transition-opacity duration-300 group-hover:opacity-100">
            VAE IPTV
          </span>
        </div>
